...
def cancel_reservation_details():
    ...
    header.config(font=(FONT, MEDIUM_FONT_SIZE, STYLE))
    ...
    cancel_date_label.config(font=(FONT, MEDIUM_FONT_SIZE, STYLE))
    ...
    cancel_button.config(font=(FONT, MEDIUM_FONT_SIZE, STYLE))
