    ...
    if not on_loan and not on_reserve:
        ...
        if no_fine:
            ...
            if reservations_made <= 1:
                ...
                success_label.config(font=(FONT, MEDIUM_FONT_SIZE, STYLE))
                ok_button = Button(win, text = "Ok", command = win.destroy)
                ok_button.place(relx=0.5, rely=0.9, anchor="center")
                ok_button.config(font=(FONT, MEDIUM_FONT_SIZE, STYLE))
                ...
                error_label.config(font=(FONT, MEDIUM_FONT_SIZE, STYLE))
                back_button = Button(win, text = "Back to Reserve Function", command = win.destroy)
                back_button.place(relx=0.5, rely=0.9, anchor="center")
                back_button.config(font=(FONT, MEDIUM_FONT_SIZE, STYLE))
...
def confirmation_window():
    ...
    #slide 35
        ...
        confirmation_label.config(font=(FONT, MEDIUM_FONT_SIZE, STYLE))
...
def reservation_details():
    ...
    image = Image.open("./assets/bg1.jpg")
    ...
    instructions.config(font=(FONT, MEDIUM_FONT_SIZE, STYLE))
    ...
    membership_id_label.config(font=(FONT, MEDIUM_FONT_SIZE, STYLE))
    ...
    reserve_button.config(font=(FONT, MEDIUM_FONT_SIZE, STYLE))
