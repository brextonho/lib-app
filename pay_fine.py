    ...
    try:
        ...
        if got_fine: 
            ...
            if fine_amount == int(payment_amount):
                ...
                success_label = Label(win, text = "Fine successfully paid", bg = "#b0f556")
                ...
                error_label2.place(relx=0.5, rely=0.3, anchor="center")
            ...
            error_label2 = Label(win, text = "Member has no fine.")
            error_label2.config(font=(FONT, SMALL_FONT_SIZE, STYLE))
            error_label2.place(relx=0.5, rely=0.3, anchor="center")
            ...
            label1 = Label(win, text="Errorb!", bg="#eb1e1e")
